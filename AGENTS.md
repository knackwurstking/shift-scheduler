...
## Design Rules
- **`~/.config/opencode/DESIGN.md`** — authoritative global design system: colors, typography, layout, table styles, dark/light mode, responsive behavior. Do NOT edit this file.
- **`DESIGN_OVERRIDES.md`** — override rules that deviate from the global `DESIGN.md`. Consult this first; if no override exists, follow the global `DESIGN.md`.
